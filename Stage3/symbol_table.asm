...
SYMBOL_ENTRY memcpy
SYMBOL_ENTRY memset
SYMBOL_ENTRY DbgPrint
SYMBOL_ENTRY MmGetPhysicalAddress
SYMBOL_ENTRY VdDisplayFatalError
SYMBOL_ENTRY MmFreePhysicalMemory
SYMBOL_ENTRY HalSendSMCMessage
SYMBOL_ENTRY MmAllocatePhysicalMemoryEx
SYMBOL_ENTRY NtWaitForSingleObjectEx
SYMBOL_ENTRY NtClose
SYMBOL_ENTRY RtlInitAnsiString
SYMBOL_ENTRY NtCreateFile
SYMBOL_ENTRY NtQueryInformationFile
SYMBOL_ENTRY NtReadFile
SYMBOL_ENTRY KeFlushCacheRange
SYMBOL_ENTRY KeGetCurrentProcessType
SYMBOL_ENTRY ExTerminateThread
SYMBOL_ENTRY ExCreateThread
#SYMBOL_ENTRY ExThreadObjectType
SYMBOL_ENTRY ObReferenceObjectByHandle
SYMBOL_ENTRY KeSetBasePriorityThread
SYMBOL_ENTRY ObDereferenceObject
SYMBOL_ENTRY NtCreateEvent
SYMBOL_ENTRY NtSetEvent
SYMBOL_ENTRY KeUnlockL2
SYMBOL_ENTRY KeLockL2
